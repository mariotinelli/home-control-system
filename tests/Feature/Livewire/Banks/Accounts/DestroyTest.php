...
it('should be able to destroy a bank account', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Banks\Accounts\Destroy::class, ['bankAccount' => $this->bankAccount])
        ->call('destroy')
...
it('should be not able to delete a bank account if not own it', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Banks\Accounts\Destroy::class, ['bankAccount' => $bankAccount2])
        ->call('destroy')
        ->assertForbidden();
});
