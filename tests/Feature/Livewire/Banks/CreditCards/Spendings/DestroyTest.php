...
it('should be able to delete a spending', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Banks\CreditCards\Spendings\Destroy::class, ['spending' => $this->spending])
        ->call('destroy')
...
it('should be not able to delete a spending if not credit card owner', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Banks\CreditCards\Spendings\Destroy::class, ['spending' => $spending2])
        ->call('destroy')
        ->assertForbidden();
