...
it('should be able to update a credit card', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Banks\CreditCards\Update::class, ['creditCard' => $this->creditCard])
...
it('should be not able to change the limit in case the change leaves the remaining limit negative', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Banks\CreditCards\Update::class, ['creditCard' => $creditCard2])
