...
it('should be able to delete couple spending', function () {
    ...
    $lw = livewire(\App\Http\Livewire\Couple\Spending\Destroy::class, ['coupleSpending' => $this->coupleSpending])
        ->call('save');
...
it('should be not able to delete couple spending if not owner', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Couple\Spending\Destroy::class, ['coupleSpending' => $coupleSpending2])
        ->call('save')
        ->assertForbidden();
...
it('should be not able to delete couple spending if not has permission', function () {
    ...
    // Act
    livewire(\App\Http\Livewire\Couple\Spending\Destroy::class, ['coupleSpending' => $this->coupleSpending])
        ->call('save')
        ->assertForbidden();
