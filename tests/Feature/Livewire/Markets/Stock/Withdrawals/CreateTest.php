...
it('should be create a new withdraw of the market stock', function () {
    ...
    // Act
    $lw = livewire(\App\Http\Livewire\Markets\Stock\Withdrawals\Create::class, ['marketStock' => $this->marketStock])
...
test('market stock id is required', function () {
    ...
    // Arrange
    $lw = livewire(\App\Http\Livewire\Markets\Stock\Entries\Create::class, ['marketStock' => $this->marketStock])
