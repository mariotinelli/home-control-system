...
class InvestmentPolicy
{
    ...
    {
        return $user->hasPermissionTo('investment_read');
    }
    ...
    {
        return $user->hasPermissionTo('investment_create');
    }
    ...
    {
        return $user->hasPermissionTo('investment_update');
    }
    ...
    {
        return $user->hasPermissionTo('investment_delete');
    }
    ...
    {
        return $user->hasPermissionTo('investment_restore');
    }
    ...
    {
        return $user->hasPermissionTo('investment_force_delete');
    }
}
